...
const Contact = () => {
    return (
        <section class="relative z-10 overflow-hidden bg-slate-100 py-20 lg:py-[120px]">
                    ...
                    <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                        <div class="mb-12 max-w-[570px] lg:mb-0">
                            ...
                            <p class="text-body-color mb-9 text-base leading-relaxed">
                                We strive to provide the best customer service and look forward to hearing from you. Thank you for considering Nolojia for your needs!
                            </p>
                            ...
                            <div class="mb-8 flex w-full max-w-[370px]">
                                ...
                                <div class="w-full">
                                    ...
                                    <p class="text-body-color text-base">+254 717084877</p>
                                </div>
                            </div>
                            <div class="mb-8 flex w-full max-w-[370px]">
                                <div
                                ...
                                <div class="w-full">
                                    ...
                                    <p class="text-body-color text-base">nolojiaschool@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                            <form>
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        class="bg-primary border-primary w-full rounded border p-3 text-white bg-[#0d0452] hover:bg-[#daa520] transition hover:bg-opacity-90"
                                    >
                                        Send Message
                                    </button>
                                </div>
