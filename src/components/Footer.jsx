        ...
        <div className="px-4 pt-16 bg-[#0d0452] text-white   sm:max-w-xl min-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                <div className="sm:col-span-2">
                    ...
                    >
                        <img src={logo} className='w-32 object-fit' alt="" />
                    </a>
                    <div className="mt-6 lg:max-w-sm">
                        <p className="text-sm text-white">
                            Through training in market-relevant skills, we assist learners
                            in developing career options with greater assurance and capability.
                        </p>
            ...
            <div className="flex flex-col-reverse justify-center pt-5 pb-10 border-t lg:flex-row">
                <p className="text-sm text-white text-center">
                    © Copyright {new Date().getFullYear()} Nolojia. All rights reserved.
                </p>
